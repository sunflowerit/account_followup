...
class report_rappel(report_sxw.rml_parse):
    ...
    def _get_text(self, stat_line, followup_id, context=None):
        ...
        partner_line_ids = self.env['account.move.line'].search([('partner_id','=',stat_line.partner_id.id),('reconciled','=',False),('company_id','=',stat_line.company_id.id),('blocked','=',False),('debit','!=',False),('account_id.user_type_id','=',receivable_id),('followup_line_id','!=',False)])
        partner_max_delay = 0
        partner_max_text = ''
